...
#if defined(ARDUINO_ARCH_ESP32)
    evidSC = WiFi.onEvent(std::bind(&SimpleWiFi::evWiFiStationConnected,    this, std::placeholders::_1, std::placeholders::_2), SYSTEM_EVENT_STA_CONNECTED);
    evidGI = WiFi.onEvent(std::bind(&SimpleWiFi::evWiFiGotIP,               this, std::placeholders::_1, std::placeholders::_2), SYSTEM_EVENT_STA_GOT_IP);
    evidSD = WiFi.onEvent(std::bind(&SimpleWiFi::evWiFiStationDisconnected, this, std::placeholders::_1, std::placeholders::_2), SYSTEM_EVENT_STA_DISCONNECTED);
#endif
